...
WHERE a.scheduleDate='$appdate' AND scheduleId=$appid AND b.Patientid=$session");
...
$Patientid = mysqli_real_escape_string($con,$userRow['Patientid']);
...
$query = "INSERT INTO appointment (  Patientid , scheduleId , appSymptom , appComment  )
VALUES ( '$Patientid', '$scheduleid', '$symptom', '$comment') ";
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<!-- <li><a href="profile.php?patientId=<?php echo $userRow['Patientid']; ?>" >Profile</a></li> -->
							<li><a href="patientapplist.php?patientId=<?php echo $userRow['Patientid']; ?>">Appointment</a></li>
						</ul>
					</ul>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="profile.php?patientId=<?php echo $userRow['Patientid']; ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
								</li>
								<li>
									<a href="patientapplist.php?patientId=<?php echo $userRow['Patientid']; ?>"><i class="glyphicon glyphicon-file"></i> Appointment</a>
								</li>
								<li class="divider"></li>
								<li>
										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													Patient Id: <?php echo $userRow['Patientid'] ?><br>
