...
$res=mysqli_query($con,"SELECT * FROM patient WHERE Contactno=".$usersession);
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<li><a href="profile.php?patientId=<?php echo $userRow['Contactno']; ?>" >Profile</a></li> 
							<li><a href="patientapplist.php?patientId=<?php echo $userRow['Contactno']; ?>">Appointment</a></li>
						</ul>
					</ul>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="profile.php?patientId=<?php echo $userRow['Contactno']; ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
								</li>
								<li>
									<a href="patientapplist.php?patientId=<?php echo $userRow['Contactno']; ?>"><i class="glyphicon glyphicon-file"></i> Appointment</a>
								</li>
								<li class="divider"></li>
								<li>
