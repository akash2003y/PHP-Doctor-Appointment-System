                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($patientRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $patientRow['Patientid'] . "</td>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$patientRow['Patientid']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
