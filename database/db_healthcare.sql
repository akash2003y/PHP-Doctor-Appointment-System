...
INSERT INTO `appointment` (`appId`, `Patientid`, `scheduleId`, `appSymptom`, `appComment`, `status`) VALUES
...
INSERT INTO `patient` (`Patientid`, `password`, `patientFirstName`, `patientLastName`, `patientMaritialStatus`, `patientDOB`, `patientGender`, `patientAddress`, `patientPhone`, `patientEmail`) VALUES
(920517105553, '123', 'Mohan', 'M', 'single', '1992-05-17', 'male', 'Pimpri', '173567758', 'mm@gmail.com');
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_4` FOREIGN KEY (`Patientid`) REFERENCES `patient` (`Patientid`),
