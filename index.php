...
$res = mysqli_query($con,"SELECT * FROM patient WHERE Contactno = '$Contactno'");
$row=mysqli_fetch_array($res,MYSQLI_ASSOC);
if ($row['password'] == $password)
{
$_SESSION['patientSession'] = $row['Contactno'];
?>
...
//INSERT
$query = " INSERT INTO patient (  Contactno, password, patientFirstName, patientLastName,  patientDOB, patientGender,   patientEmail )
VALUES ( '$Contactno', '$password', '$patientFirstName', '$patientLastName', '$patientDOB', '$patientGender', '$patientEmail' ) ";
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="tel" for="Contactno">Contactno</label>
                                                    <input type="tel" class="form-control" name="Contactno" placeholder="Contactno pattern=[0-9]{10}"  required>
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="tel" name="Contactno " value="" class="form-control input-lg" placeholder="Contactno pattern=[0-9]{10}" required/>
